...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 24 oct. 2023 à 07:31
...
INSERT INTO `participant` (`id`, `campus_id`, `email`, `mot_passe`, `nom`, `prenom`, `telephone`, `actif`, `administrateur`, `pseudo`) VALUES
...
(5, 1, 'nicom@nicom.fr', '$2y$13$ssbAedodCHO9uRJ41R0kReV/HqudF1ReBkfaY8hm6RbJqjXU7xiAO', 'nicom', 'nicom', NULL, 1, 1, 'nicom'),
...
(4, 1, 1, 1, 5, 'Ballade en péniche', '2023-11-23 12:54:26', 1, '2023-10-27', 10, 'Ballade en péniche'),
